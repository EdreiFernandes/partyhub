...
const games: GameModel[] = [
  ...
  //TODO: Adicionar descrição e como jogar do jogo de dicionário
  new GameModel(3, 'Dicionário', 'book', 'Tente enganar seus coleguinhas', '🎯 OBJETIVO: Encontrar palavras que não existem no dicionário.\n\n🎮 COMO JOGAR:\n1. Um jogador escolhe uma palavra que não existe no dicionário\n2. Os outros jogadores tentam adivinhar a palavra\n3. Se acertarem, a palavra é adicionada ao dicionário\n4. Se errarem, o jogador que escolheu a palavra ganha um ponto\n5. O jogo termina quando todos os jogadores tiverem escolhido uma palavra\n6. O jogador com mais pontos ganha o jogo\n\n💡 DICAS:\n• Escolha palavras difíceis de serem encontradas\n• Seja criativo e inovador\n• Divirta-se e seja engraçado!\n\n👥 JOGADORES: 2 ou mais pessoas\n⏱️ DURAÇÃO: 5-15 minutos por rodada', '/dictionary'),
];
